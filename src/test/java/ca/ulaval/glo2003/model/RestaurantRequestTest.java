...
import static ca.ulaval.glo2003.models.RestaurantRequest.*;
...
public class RestaurantRequestTest {
    ...
    private static final String VALID_OWNER_ID = "ownerId";

    @Test
    void givenMatchingOwnerIds_whenVerifyRestaurantOwnership_shouldNotThrowException() {
        assertDoesNotThrow(() -> RestaurantRequest.verifyRestaurantOwnership(VALID_OWNER_ID, "ownerId"));
    }

    @Test
    void givenNonMatchingOwnerIds_whenVerifyRestaurantOwnership_shouldThrowNotFoundException() {
        assertThrows(NotFoundException.class, () -> RestaurantRequest.verifyRestaurantOwnership(VALID_OWNER_ID, "actualOwnerId"));
    }
    ...
    @Test
    public void givenFuzzySearchIsNull_whenVerifyFuzzySearchNotNull_shouldThrowInvalidParameterException() {
        FuzzySearch fuzzySearch = null;

        assertThatThrownBy(() -> verifyFuzzySearchNotNull(fuzzySearch))
